...
# Añadir la ruta del entorno virtual de PySide6 instalado con pipx
pipx_venvs = os.path.expanduser('~/.local/share/pipx/venvs')
pyside6_path = os.path.join(pipx_venvs, 'pyside6', 'lib', 'python3.12/site-packages')
sys.path.append(pyside6_path)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.update_preview()
        center_layout.addWidget(self.preview_label, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        controls_layout.addWidget(self.start_num, alignment=Qt.AlignmentFlag.AlignCenter)

        controls_layout.addWidget(QLabel("End Number:"))
        self.end_num = QLineEdit()
        self.end_num.setFixedWidth(160)
        controls_layout.addWidget(self.end_num, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        controls_layout.addWidget(position_group, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        controls_layout.addWidget(color_group, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        controls_layout.addWidget(digits_group, alignment=Qt.AlignmentFlag.AlignCenter)

        # Start button
        self.start_button = QPushButton("Start Processing")
        self.start_button.setFixedWidth(160)
        self.start_button.clicked.connect(self.start_processing)
        controls_layout.addWidget(self.start_button, alignment=Qt.AlignmentFlag.AlignCenter)
